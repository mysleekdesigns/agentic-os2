...
export const ClaudeCodeLocalProviderSchema = z
  ...
  .strict();
export type ClaudeCodeLocalProviderConfig = z.infer<
  typeof ClaudeCodeLocalProviderSchema
>;
...
export const AnthropicApiProviderSchema = z
  ...
  .strict();
export type AnthropicApiProviderConfig = z.infer<
  typeof AnthropicApiProviderSchema
>;
...
export const MemoryConfigSchema = z
  .object({
    ...
    default_scopes: z
      .array(z.string())
      .default(['project', 'user_preferences']),
  })
  .strict();
...
export const ApprovalsConfigSchema = z
  .object({
    channels: z
      .array(z.enum(['cli', 'web', 'slack', 'github']))
      .default(['cli']),
